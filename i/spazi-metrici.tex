...
\end{enumerate}
\end{proof}
In generale, l'intersezione infinita di aperti non è aperta: ad esempio, sia $A_i=(0,1+\sfrac{1}{k})$, per $i\in\N$, l'intersezione dà come risultato $\bigcap_{i=1}^{\pinf}A_i=(0,1]$, che non è aperto né chiuso.
