...
Un naturale funzionale lineare su questi spazi è dato da una funzione $f\in\leb[q]{\Omega}$ con $q=p'$ (il coniugato di Hölder, come nella \eqref{eq:coniugato-holder}), tramite la quale si definisce il funzionale
\begin{equation}
