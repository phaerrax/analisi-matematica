...
Diremo che la frontiera è orientata in senso \emph{positivo} (e scriveremo $+\partial D$) se il versore normale ``punta'' all'esterno del dominio (come, ad esempio, nella figura \ref{fig:versore-tangente-normale}).
