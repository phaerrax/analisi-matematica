...
\begin{equation*}
	\int_{[0,1]}\chi_{\Q}(x)\dd x=1\mu\big(\Q\cap[0,1]\big)+0\mu\big( (\Q\setminus\R)\cap[0,1]\big)
\end{equation*}
...
Si indica con $L(E)$ lo spazio delle funzioni sommabili su un insieme $E$ misurabile.
