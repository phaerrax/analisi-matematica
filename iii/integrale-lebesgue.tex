...
\begin{lemma}[di Fatou] \label{l:fatou}
...
\end{teorema}
Di conseguenza, $\rie{[a,b]}\subset L([a,b])$, con un'inclusione stretta, dato che esistono funzioni integrabili secondo Lebesgue in un intervallo compatto, ma non secondo Riemann.
