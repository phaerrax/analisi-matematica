...
Detto ciò, abbiamo già incontrato in precedenza alcuni elementi di $\R^n_*$: i differenziali di funzioni (scalari).
...
Dobbiamo quindi restringere la classe degli insiemi ``buoni'' che ci permettano di dire quando una forma è chiusa è anche esatta: partiamo dagli insiemi \emph{stellati}.
